...
def get_args():
    ...
    parser.set_defaults(cuda=False) # original value is true
    ...
    parser.add_argument('--load', type=str, default='./data/bert/bert/model.pth',
                        help='path to load the final model')
    parser.add_argument('--test-model', type=str, default='./data/bert/bert/model.pth',
                        help='path to load the test model')
    # parser.add_argument('--load', type=str, default='./data/bert/wechat_bert/model.pth',
    #                     help='path to load the final model')
